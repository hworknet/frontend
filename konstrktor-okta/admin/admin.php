...
<div class="header">
	...
	<div class="change"> 
		<a href="https://hwork.net/okta/admin/change.php" class="izm"> Номера </a> 
	</div> |

	<span class="transparent">.</span>
	<form action="" method="post">
	<input type="submit" name="ok" value="Очистить" class="change1b">
	</form>
...
if (isset($_REQUEST['ok'])) {
	...
	header("Location: https://hwork.net/okta/admin/admin.php");
    exit();
	} 
